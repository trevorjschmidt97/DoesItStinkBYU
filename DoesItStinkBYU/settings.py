"""
Django settings for DoesItStinkBYU project.
...
SECRET_KEY = 'yv3%du)f!qpuor-+30*=4gjgrjnv^2)d=a5yzti7vk)fqlsx+d'
...
INSTALLED_APPS = [
    ...
    'selectAllDislikes.apps.SelectalldislikesConfig',
    'selectAllLikes.apps.SelectalllikesConfig',
    ...
    'selectLeaders.apps.SelectleadersConfig',
...
ROOT_URLCONF = 'DoesItStinkBYU.urls'
...
WSGI_APPLICATION = 'DoesItStinkBYU.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'DoesItStink/static')
]   
